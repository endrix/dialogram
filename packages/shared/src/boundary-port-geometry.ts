...
export namespace BoundaryPortGeometry {
    ...
    export const ROW_PITCH_PX = 22;
    /** The name's line box. Its centre is the axis. */
    export const NAME_LINE_HEIGHT_PX = 12;
    /** The type's line box, directly below the name's. */
    export const TYPE_LINE_HEIGHT_PX = 10;

    export const NAME_FONT_PX = 9.5;
    export const TYPE_FONT_PX = 8;

    /** Between the glyph and the first character of text. */
    export const GLYPH_TEXT_GAP_PX = 4;

    /** An input's glyph: a plain arrow, pointing into the diagram. */
    export const SOURCE_ARROW: BoundaryGlyphBox = { width: 8, height: 9 };
    /** An output's glyph: an arrow that stops against a bar, like a terminal. */
    export const SINK_ARROW: BoundaryGlyphBox = { width: 7, height: 9 };
    export const SINK_BAR: BoundaryGlyphBox = { width: 2, height: 11 };
     ...
     */
    export const HIT: BoundaryGlyphBox = { width: 20, height: ROW_PITCH_PX };
